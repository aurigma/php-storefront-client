 ...
 */
class ProjectTransitionConflictDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectTransitionConflictDto';
    ...
    {
        $this->container['available_transitions'] = $data['available_transitions'] ?? null;
    }
