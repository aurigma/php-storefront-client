...
class TenantInfoDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tenancy_name', $data ?? [], null);
        $this->setIfExists('tenant_creation_time', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($tenancy_name)) {
            array_push($this->openAPINullablesSetToNull, 'tenancy_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tenancy_name', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($tenant_creation_time)) {
            throw new \InvalidArgumentException('non-nullable tenant_creation_time cannot be null');
        }
