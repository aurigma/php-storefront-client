 ...
 */
class ProjectItemResourceParametersDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectItemResourceParametersDto';
