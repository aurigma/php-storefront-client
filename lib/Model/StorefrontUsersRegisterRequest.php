...
/**
 * StorefrontUsersRegisterRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class StorefrontUsersRegisterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorefrontUsers_Register_request';
    ...
    {
        $this->setIfExists('storefront_user_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($storefront_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'storefront_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('storefront_user_id', $nullablesSetToNull);
            if ($index !== FALSE) {
