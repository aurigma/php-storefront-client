...
**mockup_type** | [**\Aurigma\Storefront\Model\ProductVariantMockupType**](ProductVariantMockupType.md) |  | [optional]
**surface_index** | **int** | Surface index indicates a surface of a design to which mockup should be applied. | [optional]
**surface_usage_type** | [**\Aurigma\Storefront\Model\SurfaceUsageType**](SurfaceUsageType.md) |  | [optional]
